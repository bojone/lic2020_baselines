...
# 加载数据集
train_data = load_data('/root/baidu/datasets/ie/train_data/train_data.json')
valid_data = load_data('/root/baidu/datasets/ie/dev_data/dev_data.json')

# 读取schema
with open('/root/baidu/datasets/ie/schema.json') as f:
...
if __name__ == '__main__':
    ...
    # predict_to_file('/root/baidu/datasets/ie/test1_data/test1_data.json', 'ie_pred.json')
